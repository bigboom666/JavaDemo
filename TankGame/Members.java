        ...
        while (true) {
            ...
            switch (temp) {
                ...
                case 0:
                    // 敌人的方向向上 y 轴减小
                    for (int i = 0; i < 30; i++) {
                        System.out.println(Thread.currentThread().getName()+"isTouch:\t"+this.isTouchOther());
                        if ((y > 0) && (this.isTouchOther() != 0)) {      //造成重叠之后无法移动的原因
                            y -= speed;
...
class MyTank extends Tanks {
    ...
    public void moveUp() {
        if ((this.y >= 0) && (this.isTouchOther() != 0)) this.y -= this.speed;          //自己坦克可以出界bug
        //System.out.println("x:\t"+this.x+",y:\t"+this.y);
    }

    // 控制坦克向右移动, 向右移动 应该是 x 轴的值 加大
    public void moveRight() {
        if ((this.x <= 365) && (this.isTouchOther() != 1)) this.x += this.speed;         //坦克向右 向下 原点在哪，怎么画的
        //System.out.println("x:\t"+this.x+",y:\t"+this.y);
    ...
    public void moveDown() {
        if ((this.y <= 245) && (this.isTouchOther() != 2)) this.y += speed;
        //System.out.println("x:\t"+this.x+",y:\t"+this.y);
    }

    // 控制坦克向左移动, 向左移动应该是 x 轴 减小
    public void moveLeft() {
        if ((this.x >= 0) && (this.isTouchOther() != 3)) this.x -= this.speed;
        //System.out.println("x:\t"+this.x+",y:\t"+this.y);
    }
}
